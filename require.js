...
// Generated by CoffeeScript 1.6.3
define('utils/time-now',[], function() {
  var timeNow;
...
define('utils/log',['jquery', './time-now'], function($, timeNow) {
...
require(['utils/log', 'settings'], function(log, settings) {
  log('main.coffee executed');
  return log('settings:', settings);
});
...
define('jquery-wrapper',['jquery'], function ($) {
	return $.noConflict();
});
